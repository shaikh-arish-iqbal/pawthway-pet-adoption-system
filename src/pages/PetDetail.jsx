...
import { Heart, FileText, Download } from "lucide-react"; // Import FileText and Download icons
...
  const vaccineCertificateUrl = pet.vaccineCertificateUrl;
  
  // Check if the file is likely an image (to display it) or not (to offer download)
  const isImage = vaccineCertificateUrl && 
    (vaccineCertificateUrl.includes('jpeg') || 
    vaccineCertificateUrl.includes('jpg') || 
    vaccineCertificateUrl.includes('png'));
...
              {/* NEW: Vaccine Certificate Section */}
              {vaccineCertificateUrl && (
                <motion.div
                  initial={{ opacity: 0, x: 30 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.8, delay: 0.5 }}
                  className="mb-6 border border-[#BEB7A4]/20 rounded-xl p-4"
                >
                  <h3 className="text-lg font-bold text-[#FF1B1C] mb-3 flex items-center gap-2">
                    <FileText className="w-5 h-5" />
                    Health Records
                  </h3>
                  
                  {isImage ? (
                    // Display image if file type is likely an image
                    <div className="relative w-full h-40 bg-gray-100 rounded-lg overflow-hidden">
                      <img 
                        src={vaccineCertificateUrl} 
                        alt="Vaccination Certificate" 
                        className="w-full h-full object-contain"
                      />
                    </div>
                  ) : (
                    // Offer download option for PDF or other file types
                    <a
                      href={vaccineCertificateUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 bg-[#FF7F11]/10 text-[#FF7F11] p-3 rounded-lg font-semibold hover:bg-[#FF7F11]/20 transition-colors"
                    >
                      <Download className="w-5 h-5" />
                      <span>Download Vaccination Certificate</span>
                    </a>
                  )}
                </motion.div>
              )}
