...
export default function About() {
  return (
    <div>
      ...
      <div className="min-h-screen bg-[#FFFFFC] text-[#000000] px-6 py-30">
      <div className="max-w-5xl mx-auto">
        ...
        >
          Welcome to our Pet Adoption Platform! 🐾 We connect animals with loving
          families and help shelters manage pets in a smarter, simpler way.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <p>
              Create listings, update pet info, and manage applications through
